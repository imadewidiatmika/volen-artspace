        ...
        <div class="container-custom"> {{-- Laravel form: method POST, action ke route 'registration.step2' --}}
            <form >
                ...
                <div id="dateInputWrapper" class="mb-4 hidden">
                    ...
                    <select class="form-select" id="dateInput" name="date" aria-label="Available Dates selection">
                ...
                <div id="timeInputWrapper" class="mb-4 hidden">
                    <label for="timeInput" class="form-label form-label-custom">Time :</label>
                    <select class="form-select" id="timeInput" name="time" aria-label="Available Times selection">
                ...
                <div id="step3Content" class="hidden">
                    ...
                    <div class="d-grid gap-2">
                         <a href="{{ route('registration.step2') }}" class="btn btn-dark btn-lg ">NEXT</a>
                    </div>
                </div>
            </form>
        </div>
